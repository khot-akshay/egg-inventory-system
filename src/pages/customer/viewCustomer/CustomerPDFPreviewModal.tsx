...
interface CustomerPDFPreviewModalProps {
  open: boolean;
  onClose: () => void;
  data: any[];
  summary: SummaryItem[];
...
const CustomerPDFPreviewModal: React.FC<CustomerPDFPreviewModalProps> = ({
  open,
  onClose,
  data,
  summary,
  ...
  const generateFilename = () =>
    `CustomerQuickbills_${moment().format('YYYY-MM-DD_hh-mm-ss')}.pdf`;
    ...
    >
      ...
      >
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
          ...
          <Typography variant="h6" sx={{ fontWeight: 700, fontSize: '1rem' }}>
            Customer Quickbill PDF Preview
          </Typography>
        </Box>
      ...
      >
        ...
        >
          ...
          >
            <CommonReportPDF
              title="Customer Quickbill Report"
              shopName={shopName}
...
export default CustomerPDFPreviewModal;
