...
import StaffExpensePDFPreviewModal from './StaffExpensePDFPreviewModal';

interface StaffExpenseReportAdapterProps {
    searchQuery?: string;
    rowsPerPage: number;
    startDate?: string;
    endDate?: string;
...
const StaffExpenseReportAdapter: React.FC<StaffExpenseReportAdapterProps> = ({
    searchQuery,
    rowsPerPage,
    startDate,
    endDate,
    selectedCategoryId,
    selectedShopId,
    apiUrl = '/api/v1/shop/getAllExpenses',
}) => {
...
export default StaffExpenseReportAdapter;
