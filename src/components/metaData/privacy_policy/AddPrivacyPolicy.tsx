...
const schema = yup.object().shape({
    ...
    model_type: yup.string().nullable().required('Panel Type is required.'),
})
...
const AddPrivacyPolicy = ({ open, handleClose, fetchData, selectedItem }: Props) => {
        ...
        >
            ...
            >
                ...
                <Typography sx={{ fontSize: '25px', fontWeight: 'bold', textAlign: 'Start', flexGrow: 1, paddingLeft: '10px' }}>
                    {selectedItem ? 'Update' : 'Add'} Privacy Policy {' '}
                </Typography>
