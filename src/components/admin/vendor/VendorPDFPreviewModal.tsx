...
interface VendorPDFPreviewModalProps {
  open: boolean;
  onClose: () => void;
  data: any[];
  summary: SummaryItem[];
...
const VendorPDFPreviewModal: React.FC<VendorPDFPreviewModalProps> = ({
  open,
  onClose,
  data,
  summary,
  ...
  const generateFilename = () =>
    `VendorPurchases_${moment().format('YYYY-MM-DD_hh-mm-ss')}.pdf`;
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <CommonReportPDF
              title="Egg Vendor Purchases Report"
              shopName={shopName}
...
export default VendorPDFPreviewModal;
