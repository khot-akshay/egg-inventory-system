...
const ExpensePDFPreviewModal: React.FC<ExpensePDFPreviewModalProps> = ({
  open,
  onClose,
  data,
  summary,
  ...
  const generateFilename = () =>
    `ExpenseExpenses_${moment().format('YYYY-MM-DD_hh-mm-ss')}.pdf`;
...
export default ExpensePDFPreviewModal;
