...
interface CashBookPDFPreviewModalProps {
  open: boolean;
  onClose: () => void;
  data: any[];
  summary: SummaryItem[];
...
const CashBookPDFPreviewModal: React.FC<CashBookPDFPreviewModalProps> = ({
  open,
  onClose,
  data,
  summary,
  ...
  const generateFilename = () =>
    `CashBook_${moment().format('YYYY-MM-DD_hh-mm-ss')}.pdf`;
...
export default CashBookPDFPreviewModal;
